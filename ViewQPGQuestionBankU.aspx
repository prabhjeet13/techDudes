<%@ Page Title="" Language="C#" MasterPageFile="~/QPG.master" AutoEventWireup="true" CodeFile="ViewQPGQuestionBankU.aspx.cs" Inherits="ViewQPGQuestionBankU" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" CssClass="auto-style9" DataKeyNames="SubName" DataSourceID="SqlDataSource1" ForeColor="Red" GridLines="None" style="margin-left: 65px" Visible="False" Width="597px" EmptyDataText="Sorry, Record Not Found!">
